...
game_font = pygame.font.Font("dinosaur-game\\assets\PressStart2P-Regular.ttf", 24)
...
class Dino(pygame.sprite.Sprite):
    def __init__(self, x_pos, y_pos):
        ...
        self.running_sprites.append(pygame.transform.scale(
            pygame.image.load("dinosaur-game\\assets/Dino1.png"), (80, 100)))
        self.running_sprites.append(pygame.transform.scale(
            pygame.image.load("dinosaur-game\\assets/Dino2.png"), (80, 100)))

        self.ducking_sprites.append(pygame.transform.scale(
            pygame.image.load(f"dinosaur-game\\assets/DinoDucking1.png"), (110, 60)))
        self.ducking_sprites.append(pygame.transform.scale(
            pygame.image.load(f"dinosaur-game\\assets/DinoDucking2.png"), (110, 60)))
    ...
    def __init__(self, x_pos, y_pos):
        ...
        for i in range(1, 7):
            current_sprite = pygame.transform.scale(
                pygame.image.load(f"dinosaur-game\\assets/cacti/cactus{i}.png"), (100, 100))
    ...
    def __init__(self):
        ...
        self.sprites.append(
            pygame.transform.scale(
                pygame.image.load("dinosaur-game\\assets/Ptero1.png"), (84, 62)))
        self.sprites.append(
            pygame.transform.scale(
                pygame.image.load("dinosaur-game\\assets/Ptero2.png"), (84, 62)))
        self.current_image = 0
...
ground = pygame.image.load("dinosaur-game\\assets\ground.png")
ground = pygame.transform.scale(ground, (1280, 20))
ground_x = 0
ground_rect = ground.get_rect(center=(640, 400))
cloud = pygame.image.load("dinosaur-game\\assets/cloud.png")
...
# Sounds
death_sfx = pygame.mixer.Sound("dinosaur-game\\assets/sfx/lose.mp3")
points_sfx = pygame.mixer.Sound("dinosaur-game\\assets/sfx/100points.mp3")
jump_sfx = pygame.mixer.Sound("dinosaur-game\\assets/sfx/jump.mp3")
